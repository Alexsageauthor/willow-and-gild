...
const BUNDLES = [
  { id: '4_Complete_Collection', name: 'The Complete Collection',
  ...
  { id: '2_Invitation_Suite', name: 'The Invitation Suite',
  ...
  { id: '1_Planning_Bundle', name: 'The Planning Bundle',
  ...
  { id: '3_Reception_Decor', name: 'Reception &amp; Decor',
  ...
  { id: '8_DayOf_Coordination', name: 'Day-Of Coordination',
  ...
  { id: '5_ThankYou_Bundle', name: 'The Thank You Bundle',
  ...
  { id: '6_Digital_Wedding_Kit', name: 'The Digital Wedding Kit',
  ...
  { id: '7_Digital_Announcement_Set', name: 'The Digital Announcement Set',
